...
if &t_Co >= 256 || has("gui_running")
	...
	set background=dark
		...
		hi tsxTagName ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
		hi tsxCloseString ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
		hi ReduxKeywords ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
		hi ReactState ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
		hi ReactProps ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
...
set t_Co=16
	...
	set background=dark
		...
		hi tsxTagName ctermbg=NONE ctermfg=blue cterm=NONE
		hi tsxCloseString ctermbg=NONE ctermfg=blue cterm=NONE
		hi ReduxKeywords ctermbg=NONE ctermfg=blue cterm=NONE
		hi ReactState ctermbg=NONE ctermfg=blue cterm=NONE
		hi ReactProps ctermbg=NONE ctermfg=blue cterm=NONE
endif
